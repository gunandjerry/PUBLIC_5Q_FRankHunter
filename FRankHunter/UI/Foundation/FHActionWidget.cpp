...
#include "UI/Foundation/FHActionWidget.h"
#include "CommonInputBaseTypes.h"
#include "CommonInputSubsystem.h"
#include "EnhancedInputSubsystems.h"

FSlateBrush UFHActionWidget::GetIcon() const
{
	/** If there is an Enhanced Input action associated with this widget, then search for any keys bound to that action and display those instead of the default data table settings.
...
UEnhancedInputLocalPlayerSubsystem* UFHActionWidget::GetEnhancedInputSubsystem() const
{
